...
def main():
    ...
    print("                     Descifrado            ")
    print("                     RONDA         1")
    p1Inm2=permutacionInv(p2m2)
    s1Inm2=sustitucionInv(p1Inm2)
    p1Inm4=permutacionInv(p2m4)
    s1Inm4=sustitucionInv(p1Inm4)
    p1Inm6=permutacionInv(p2m6)
    s1Inm6=sustitucionInv(p1Inm6)
    p1Inm8=permutacionInv(p2m8)
    s1Inm8=sustitucionInv(p1Inm8)
    print(p2m2,p2m1,"  ",p2m4,p2m3,"  ",p2m6,p2m5,"  ",p2m8,p2m7)
    print(p1Inm2,p2m1,"  ",p1Inm4,p2m3,"  ",p1Inm6,p2m5,"  ",p1Inm8,p2m7)
    print(s1Inm2,p2m1,"  ",s1Inm4,p2m3,"  ",s1Inm6,p2m5,"  ",s1Inm8,p2m7)
    
    print("                     RONDA         2")
    p1Inm1=permutacionInv(p2m1)
    s1Inm1=sustitucionInv(p1Inm1)
    p1Inm3=permutacionInv(p2m3)
    s1Inm3=sustitucionInv(p1Inm3)
    p1Inm5=permutacionInv(p2m5)
    s1Inm5=sustitucionInv(p1Inm5)
    p1Inm7=permutacionInv(p2m7)
    s1Inm7=sustitucionInv(p1Inm7)
    print(p2m1,s1Inm2,"  ",p2m3,s1Inm4,"  ",p2m5,s1Inm6,"  ",p2m7,s1Inm8)
